...
import { sendCalibrationCommand, clearCalibration } from "@/lib/calibration";
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-muted-foreground max-w-md mx-auto">
            Kalibrasi sensor pH dan TDS pada Rack {rackId}. Setiap kalibrasi
            mencakup pengukuran suhu air untuk kompensasi otomatis.
          </p>
        </div>
        ...
        {resetResult && (
          <div
            className={`mb-6 rounded-xl border-2 p-4 text-center ${
              resetResult === "success"
          ...
          >
            ...
            >
              {resetResult === "success"
                ? "✅ Kalibrasi berhasil direset! Sensor kembali ke nilai default."
                : "❌ Gagal mereset kalibrasi. Periksa koneksi ESP32."}
            </p>
          </div>
        )}
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
                Kalibrasi 3 titik menggunakan serbuk buffer pH 4.00, 6.86, dan
                9.18. Dengan kompensasi suhu otomatis.
              </p>
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
                ...
                Kompensasi suhu otomatis berdasarkan tabel referensi.
              </p>
        ...
        {phDone && tdsDone && (
          <div className="mt-8 rounded-2xl border-2 border-emerald-500/20 bg-emerald-500/5 p-6 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              ...
              ESP32 sekarang mengirim nilai yang sudah dikalibrasi ke dashboard.
            </p>
            <Link href="/">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Menghapus semua koefisien kalibrasi pada ESP32 Rack {rackId}.
                Sensor akan kembali ke pembacaan default.
              </p>
            </div>
            {!showResetConfirm ? (
              <Button
